      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            {/*
              Plain <a>, not <Link>: /mortgage-payment is a static hub page
              generated by scripts/generate-pages.ts, not a React route. A
              client-side <Link> would land on the SPA's 404 instead.
            */}
            <a
