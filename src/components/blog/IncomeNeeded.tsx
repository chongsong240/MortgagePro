    ...
    <article className="max-w-3xl mx-auto py-8 px-4">
      ...
      <section id="calculator-data" className="mb-10">
        ...
        <p className="text-sm text-muted-foreground mb-2">
          ...
          homeowners insurance held at a flat $142/mo for this illustration — the mean across our 51 state averages is $1,492/yr (NAIC 2022). PMI at 0.7% of loan annually. 
